...
*Store More, Stress Less – Your Space, Your Way!. You can [preview the theme to see what it looks like](http://pages-themes.github.io/midnight), or even [use it today](#usage).*
...
```yml
title: Main Street Storage
description: A test website for a small self storage business
```
